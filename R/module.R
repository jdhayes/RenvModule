  ...
  methods=list(
    ...
    init=function(){
      ...
      for (x in seq(1,length(base_env))) {
        ...
        if (base_env[[x]][1]=="LOADEDMODULES" || base_env[[x]][1]=="MODULESHOME" || base_env[[x]][1]=="MODULEPATH" || base_env[[x]][1]=="MODULES_DIR" || base_env[[x]][1]=="MODULES_LMCONFLICT" || base_env[[x]][1]=="HPCC_MODULES"){
